      ...
      <div className="flex gap-2">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-10 py-3 rounded-xl border border-surface-200 dark:border-surface-700 bg-white dark:bg-surface-900 text-foreground placeholder-surface-400 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 text-sm"
          />
          ...
          {showDropdown && (
            <>
              ...
              <div className="absolute top-full left-0 right-0 mt-1 z-20 bg-white dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-xl shadow-lg overflow-hidden">
                <div className="px-3 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider border-b border-surface-100 dark:border-surface-800">
                  Accès rapide
                </div>
                {quickOptions.map((opt) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-foreground hover:bg-surface-50 dark:hover:bg-surface-800 transition-colors text-left"
                  >
                ...
                <div className="border-t border-surface-100 dark:border-surface-800">
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-muted-foreground hover:bg-surface-50 dark:hover:bg-surface-800 transition-colors text-left"
                  >
