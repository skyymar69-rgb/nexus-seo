...
export function CTA() {
  return (
    <section className="section-y px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-surface-50 dark:bg-surface-900/50">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="relative rounded-3xl overflow-hidden bg-brand-600 p-px shadow-2xl shadow-brand-500/20 dark:shadow-brand-500/10">
