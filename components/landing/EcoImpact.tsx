  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-20 dark:opacity-5 pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-green-300 dark:bg-green-400 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-emerald-300 dark:bg-emerald-400 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-500/10 border border-green-300 dark:border-green-500/20 rounded-full mb-6">
          ...
          <p className="text-lg text-surface-700 dark:text-white/70 leading-relaxed">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {optimizations.map((opt, i) => {
              const Icon = opt.icon
              return (
                <div key={i} className="rounded-2xl p-6 bg-white dark:bg-white/5 border border-green-200 dark:border-white/10 shadow-sm dark:shadow-none">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {/* WCAG AA: text-green-800 sur blanc = ratio ~7.2:1 ✓ */}
                      <p className="text-sm text-green-800 dark:text-green-300 flex items-start gap-1.5">
                        <Leaf className="w-3.5 h-3.5 mt-0.5 flex-shrink-0" aria-hidden="true" />
                        {opt.solution}
                      </p>
                    </div>
                  </div>
        ...
        <div className="rounded-2xl p-8 sm:p-10 bg-gradient-to-r from-brand-50 to-green-50 dark:from-brand-600/20 dark:to-green-600/20 border border-brand-200 dark:border-brand-500/20 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-600 hover:bg-brand-500 text-white font-bold text-sm transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-green-700 dark:bg-green-500/20 text-white dark:text-green-300 font-bold text-sm border border-green-600 dark:border-green-500/30 hover:bg-green-600 dark:hover:bg-green-500/30 transition-all"
            >
              <Leaf className="w-4 h-4" aria-hidden="true" /> Kayzen Reconditionné
            </a>
          </div>
        </div>
