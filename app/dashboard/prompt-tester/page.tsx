    ...
    <div className="space-y-6 pb-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Testez vos prompts sur les LLMs et vérifiez si votre marque est citée</p>
        </div>
      </div>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedLLMs.includes(llm.id)
                      ...
                      : 'border-surface-200 dark:border-surface-700 text-muted-foreground hover:border-surface-300'
                  )}
                >
              ...
              <div key={r.llm} className="bg-white/[0.03] rounded-xl border border-white/5 overflow-hidden">
                <div className="flex items-center justify-between px-4 py-3 border-b border-surface-100 dark:border-surface-800 bg-surface-50 dark:bg-surface-800/50">
                  ...
                  <button
                    ...
                    className="text-xs text-muted-foreground hover:text-surface-600 flex items-center gap-1"
                  >
