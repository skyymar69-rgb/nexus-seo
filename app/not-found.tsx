        ...
        <div className="max-w-lg text-center">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-2 text-xs">
            {[
              ...
              <Link key={link.href} href={link.href} className="px-3 py-1.5 rounded-full border border-surface-200 dark:border-surface-700 text-muted-foreground hover:border-brand-400 hover:text-brand-600 transition-colors">
                {link.label}
              </Link>
            ))}
          </div>
