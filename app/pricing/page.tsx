              ...
              {categories.map((cat) => {
                ...
                return (
                  <div key={cat.name} className="bg-white dark:bg-surface-900 rounded-2xl border border-surface-200 dark:border-surface-800 p-6">
                    ...
                    <h3 className="font-bold text-foreground mb-3">{cat.name}</h3>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                ...
                >
                  <summary className="flex items-center justify-between cursor-pointer px-6 py-5 text-left text-foreground font-semibold text-sm hover:bg-surface-50 dark:hover:bg-surface-800/50 transition-colors list-none [&::-webkit-details-marker]:hidden">
                    {faq.q}
                    <span className="ml-4 text-muted-foreground group-open:rotate-45 transition-transform text-xl leading-none flex-shrink-0">
                      +
                    </span>
                  </summary>
