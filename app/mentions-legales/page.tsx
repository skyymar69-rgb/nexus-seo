      ...
      <main className="bg-white dark:bg-surface-950 min-h-screen">
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl font-black text-foreground mb-3">Mentions légales</h1>
            <p className="text-muted-foreground text-sm mb-12">Dernière mise à jour : 1er avril 2026</p>
            ...
            <div className="space-y-10 text-muted-foreground">
              ...
              <div>
                ...
                <div className="card p-6 space-y-2 text-sm">
                  <p><strong className="text-foreground">Raison sociale :</strong> KAYZEN LYON</p>
                  <p><strong className="text-foreground">Forme juridique :</strong> Entreprise individuelle / Société commerciale</p>
                  <p><strong className="text-foreground">SIREN :</strong> 999 418 346 000 14</p>
                  <p><strong className="text-foreground">RCS :</strong> Lyon — 999 418 346</p>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">5. Responsabilité</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">6. Liens hypertextes</h2>
