    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <fieldset className="space-y-3 pt-1">
          ...
          {/* Notice Art. 13 RGPD */}
          <div className="flex gap-2.5 p-3.5 rounded-xl bg-white/[0.04] border border-white/10">
            <Info className="w-4 h-4 text-brand-400 flex-shrink-0 mt-0.5" aria-hidden="true" />
            <p className="text-xs text-white/50 leading-relaxed">
              <strong className="text-white/70 font-semibold">Traitement de vos données (Art. 13 RGPD) —</strong>{' '}
              Responsable : <strong className="text-white/70">Kayzen Lyon</strong>.
              ...
              <Link href="/privacy" className="text-brand-400 underline underline-offset-2">Politique complète →</Link>
            </p>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <label htmlFor="terms" className="text-sm text-white/50 leading-relaxed cursor-pointer">
              J&apos;accepte les{' '}
              <Link href="/cgu" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">conditions d&apos;utilisation</Link>
              {' '}et la{' '}
              <Link href="/privacy" className="text-brand-400 hover:text-brand-300 underline underline-offset-2">politique de confidentialité</Link>
          ...
          <div className={`flex items-start gap-2.5 p-3 rounded-xl border transition-colors ${
            agreeRgpd ? 'border-brand-500/40 bg-brand-500/5' : 'border-white/10 bg-white/[0.02]'
          }`}>
            <input
              id="rgpd-consent"
              type="checkbox"
              ...
              className="mt-0.5 w-4 h-4 rounded border-white/20 bg-white/5 text-brand-500 focus:ring-brand-500/50"
            />
            <div>
              <label htmlFor="rgpd-consent" className="text-sm font-medium text-white/70 cursor-pointer">
                J&apos;accepte le traitement de mes données personnelles
                <span className="text-red-400 ml-0.5" aria-hidden="true">*</span>
              </label>
              <p id="rgpd-consent-desc" className="text-xs text-white/40 mt-0.5">
          ...
          <div className={`flex items-start gap-2.5 p-3 rounded-xl border transition-colors ${
            agreeMarketing ? 'border-violet-500/40 bg-violet-500/5' : 'border-white/10 bg-white/[0.02]'
          }`}>
            <input
            ...
            />
            <div>
              <label htmlFor="marketing-consent" className="text-sm text-white/50 cursor-pointer">
                Recevoir les actualités & conseils Nexus SEO{' '}
                <span className="text-white/30">(facultatif)</span>
              </label>
              <p id="marketing-desc" className="text-xs text-white/30 mt-0.5">
          ...
          <p className="flex items-center gap-1.5 text-xs text-white/30">
            ...
            <a href="mailto:contact@kayzen-lyon.fr?subject=Exercice%20droits%20RGPD" className="text-brand-400/70 underline underline-offset-2 hover:text-brand-400">
              contact@kayzen-lyon.fr
            </a>
            {' '}ou{' '}
            <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-brand-400/70 underline underline-offset-2 hover:text-brand-400">CNIL</a>
          </p>
        </fieldset>
