  ...
  return (
    <div className="space-y-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-surface-200 dark:border-white/20 bg-surface-100 dark:bg-white/[0.06] text-surface-800 dark:text-white text-sm font-medium hover:bg-surface-200 dark:hover:bg-white/[0.10] transition-colors"
      >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-surface-700 dark:text-white/70 mb-1.5">
            Adresse e-mail
          </label>
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-surface-700 dark:text-white/70 mb-1.5">
            Mot de passe
          </label>
          <div className="relative">
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/signup" className="font-medium text-brand-600 dark:text-brand-300 hover:text-brand-700 dark:hover:text-brand-300">
          Créer un compte
        </Link>
      </p>
    </div>
