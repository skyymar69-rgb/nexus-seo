      ...
      <main className="bg-white dark:bg-surface-950 min-h-screen">
        <section className="py-24 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl font-black text-foreground mb-3">Conditions Générales d&apos;Utilisation et de Vente</h1>
            <p className="text-muted-foreground text-sm mb-12">En vigueur au 1er avril 2026 — Droit applicable : droit français</p>

            <div className="space-y-10 text-muted-foreground text-sm leading-relaxed">

              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 1 — Objet et définitions</h2>
                <p className="mb-3">Les présentes Conditions Générales d&apos;Utilisation et de Vente (ci-après &laquo; CGU/CGV &raquo;) régissent l&apos;utilisation de la plateforme Nexus SEO (ci-après &laquo; le Service &raquo;), accessible à l&apos;adresse <strong className="text-foreground">nexus.kayzen-lyon.fr</strong>, éditée par KAYZEN LYON (ci-après &laquo; l&apos;Éditeur &raquo;).</p>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 2 — Accès au Service</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 3 — Plans et tarifs</h2>
                  ...
                  <table className="w-full text-xs">
                    <thead className="bg-surface-50 dark:bg-surface-800">
                      <tr>
                        ...
                        <th className="text-right p-3 font-semibold text-foreground">Mensuel HT</th>
                        <th className="text-right p-3 font-semibold text-foreground">Annuel HT</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 4 — Paiement et facturation</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 6 — Utilisation du Service</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 7 — Propriété intellectuelle</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 8 — Limitation de responsabilité</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 9 — Résiliation</h2>
              ...
              <div>
                <h2 className="text-xl font-bold text-foreground mb-4">Article 10 — Droit applicable et juridiction</h2>
